...

      {
        (state.isLogin === true) ?
          <nav className='navBar'>
            ...
            <ul >
              <li> <SlBasketLoaded className="fbIcon"></SlBasketLoaded> </li>
              <li><h2> E-Commmerce</h2></li>
              <li className="homeButton"> <Link to={`/`}>Home</Link> </li>
              <li> <Link to={`/about`}>Add Product</Link> </li>
              <li> <Link to={'/gallery'}>About Us</Link> </li>
              <li className="userName"> {state.user.firstName} <button className="logoutButton" onClick={logoutHandler}>Logout</button> </li>
            </ul>
          </nav>
          : null}
